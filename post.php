...
<head>
    <title>Dawson's Geek Blog</title>
    <!-- META TAGS -->
    <meta charset="UTF-8">
...
<?php include('./includes/nav.php'); ?>
                ...
                <div class="eskimo-page-title">
                    ...
                    <div class="eskimo-page-title-meta">
                        <div class="eskimo-author-meta">
                            By <a class="author-meta" href="author.php">Dawson</a>
                        </div>
                        <div class="eskimo-cat-meta">
                            In <a href="category.php">Lifestyle</a>
                        </div>
                ...
                <div class="eskimo-page-content">
                    ...
                    <div class="eskimo-meta-tags">
                        <span class="badge badge-default"><a href="category.php">commodo</a></span>
                        <span class="badge badge-default"><a href="category.php">culpa</a></span>
                        <span class="badge badge-default"><a href="category.php">enim</a></span>
                        <span class="badge badge-default"><a href="category.php">magna</a></span>
                        <span class="badge badge-default"><a href="category.php">mandaremus</a></span>
                        <span class="badge badge-default"><a href="category.php">quorum</a></span>
                        <span class="badge badge-default"><a href="category.php">voluptatibus</a></span>
                    </div>
                    ...
                    <div id="eskimo-share-buttons" class="eskimo-share-buttons">
                        <ul class="rrssb-buttons">
                            ...
                            <li class="rrssb-facebook">
                                <a href="https://www.facebook.com/sharer/sharer.php?u=http://eskimo.Dawson.com/html/single-post.php" class="popup">
                                    <span class="rrssb-icon">
                            ...
                            <li class="rrssb-twitter">
                                <a href="https://twitter.com/intent/tweet?text=http://eskimo.Dawson.com/html/single-post.php" class="popup">
                                    <span class="rrssb-icon">
                            ...
                            <li class="rrssb-linkedin">
                                <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=http://eskimo.Dawson.com/html/single-post.php" class="popup">
                                    <span class="rrssb-icon">
                            ...
                            <li class="rrssb-tumblr">
                                <a href="http://tumblr.com/share/link?url=http://eskimo.Dawson.com/html/single-post.php&amp;name=Title%20Here">
                                    <span class="rrssb-icon">
                            ...
                            <!-- VK -->
                            <li class="rrssb-vk">
                                <a href="http://vk.com/share.php?url=http://eskimo.Dawson.com/html/single-post.php" class="popup">
                                    <span class="rrssb-icon">
                            ...
                            <li class="rrssb-googleplus">
                                <a href="https://plus.google.com/share?url=http://eskimo.Dawson.com/html/single-post.php" class="popup">
                                    <span class="rrssb-icon">
                            ...
                            <li class="rrssb-pinterest">
                                <a href="http://pinterest.com/pin/create/button/?url=http://eskimo.Dawson.com/html/single-post.php&amp;media=http://eskimo.Dawson.com/wp-content/uploads/2018/05/blog19.jpg&amp;description=Description%20Here" class="popup">
                                    <span class="rrssb-icon">
                    ...
                    <div class="eskimo-post-nav-wrapper">
                        ...
                        <div class="eskimo-post-nav-left-row">
                            <div class="eskimo-post-nav-table">
                                <a class="eskimo-post-nav" href="single-post.php">
                                    <i class="fa fa-chevron-left"></i>
                                </a>
                                <div class="eskimo-post-nav-link">
                                    <a class="eskimo-post-nav" href="single-post.php">Best Breakfast In The World</a>
                                </div>
                            </div>
                        </div>
                        <!-- NEXT POST -->
                        <div class="eskimo-post-nav-right-row">
                            <div class="eskimo-post-nav-table">
                                <div class="eskimo-post-nav-link">
                                    <a class="eskimo-post-nav" href="single-post.php">15 Of The World&#8217;s Best Carnivals</a>
                                </div>
                                <a class="eskimo-post-nav" href="single-post.php">
            ...
            <div class="eskimo-panel-inner">
                ...
                <div class="eskimo-author-box eskimo-widget">
                    ...
                    <div class="eskimo-author-box-btn">
                        <a class="btn btn-default" href="about.php">CONTACT ME</a>
                    </div>
                </div>
                <!-- RECENT POSTS -->
                ...
                <div class="eskimo-categories eskimo-widget">
                    ...
                    <ul>
                        <li>
                            <a href="category.php" title="The best restaurants, cafes, bars and shops in town.">Food &amp; Drink</a> <span class="badge badge-pill badge-default">5</span>
                        </li>
                        <li>
                            <a href="category.php" title="An up-to-date, personal urban guide.">Lifestyle</a> <span class="badge badge-pill badge-default">5</span>
                        </li>
                        <li>
                            <a href="category.php" title="Latest technology news and updates.">Technology</a> <span class="badge badge-pill badge-default">4</span>
                        </li>
                        <li>
                            <a href="category.php" title="Travel advice, information and inspiration.">Travel</a> <span class="badge badge-pill badge-default">5</span>
                        </li>
                        <li>
                            <a href="category.php" title="The latest news about movies and TV shows.">TV &amp; Movies</a> <span class="badge badge-pill badge-default">4</span>
                        </li>
                    </ul>
                </div>
                <!-- TAGS -->
    ...
    <div id="eskimo-fullscreen-search">
        <div id="eskimo-fullscreen-search-content">
            ...
            <form role="search" method="get" action="search.php" class="eskimo-lg-form">
                <div class="input-group">
